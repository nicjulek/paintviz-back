...
export class OrdemDeServicoRepository {
    ...
    async updateOrdemDeServico(id_ordem_servico: number, ordemDeServico: Partial<OrdemDeServico>): Promise<OrdemDeServico | undefined> {
        try {
            ...
            if (ordemDeServico.identificacao_veiculo !== undefined) {
                updateData.identificacao_veiculo = ordemDeServico.identificacao_veiculo;
            }

            if (ordemDeServico.data_emissao !== undefined) {
                updateData.data_emissao = ordemDeServico.data_emissao;
            }

            if (ordemDeServico.data_programada !== undefined) {
                updateData.data_programada = ordemDeServico.data_programada;
            }

            if (ordemDeServico.data_entrega !== undefined) {
                updateData.data_entrega = ordemDeServico.data_entrega;
            }

            if (ordemDeServico.modelo_veiculo !== undefined) {
                updateData.modelo_veiculo = ordemDeServico.modelo_veiculo;
            }

            if (ordemDeServico.placa_veiculo !== undefined) {
                updateData.placa_veiculo = ordemDeServico.placa_veiculo;
            }

            if (ordemDeServico.numero_box !== undefined) {
            ...
            if (ordemDeServico.data_ultima_modificacao !== undefined) {
